...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<input type="text" class="form-control" name="imagen" title="Imagen del producto" placeholder="Imagen del producto"/>
	</div>
...
<table class="table table-striped">
	...
	<?php
		...
		while($rp=mysqli_fetch_array($prod)){
			...
			$cat = $mysqli->query("SELECT * FROM categorias WHERE id = '".$rp['id']."'");
