...
<center>
	<?php if(isset($_SESSION['id_cliente'])){ ?>
		<h1 style="text-transform: uppercase;">Bienvenido <?=nombre_cliente($_SESSION['id_cliente'])?>  </h1>

	<?php	}?>
			<br>
			<h2>Estos son los últimos productos agregados! </h2>
		   </center><br>
<?php
$q = $mysqli->query("SELECT * FROM productos WHERE oferta = 0 ORDER BY id DESC LIMIT 5");
