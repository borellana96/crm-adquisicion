...
if(isset($enviar)){
	...
	$res=$mysqli->query("INSERT INTO productos  (id,price,imagen,name,id_categoria,oferta,stock,descripcion) VALUES (NULL,'$price','$imagen','$name','$categoria','$oferta','$stock','$descripcion')");
	if ($res) {
			alert("Producto agregado",1,'agregar_producto');
		# code...
	} else{
					alert("Producto  no pudo ser agregado",0,'agregar_producto');
	}
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<input type="text" class="form-control" name="imagen" title="Imagen del producto" placeholder="Coloque url o link de la imagen"/>
	</div>
	<div class="form-group">
